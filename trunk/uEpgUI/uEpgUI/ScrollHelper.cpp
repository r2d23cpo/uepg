...
CScrollHelper::CScrollHelper(bool hasScrollbars)
{
    m_attachWnd   = NULL;
...
void CScrollHelper::AttachWnd(CScrollableWnd* pWnd)
{
    m_attachWnd = pWnd;
}
...
void CScrollHelper::UpdateScrollInfo()
{
    ...
    {
        m_attachWnd->Scroll(deltaPos.cx, deltaPos.cy);
    }                                                        
}
